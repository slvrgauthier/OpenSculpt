...
int Model::getMinDetailLevel() const { return m_detailLevel[0]; }
int Model::getCurrentDetailLevel() const { return m_detailLevel[1]; }
int Model::getMaxDetailLevel() const { return m_detailLevel[2]; }
...
{
    if(m_detailLevel[1] < m_detailLevel[2])
    {
