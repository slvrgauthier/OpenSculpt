		...
		\section{API}
			...
			\subsection{Les méthodes de la classe Mesh}
				...
				\subsubsection{Ajout d'une face}
					...
					existants et crée les autres. Enfin, la face est créée sous forme d'un TRIANGLE_FAN (éventail), dont la base sera le premier point 
				...
				\subsubsection{Récupération de points}
					...
					uniquement les trois points de la face contenant le centre de la zone. De plus, la liste de points renvoyée contient aussi le centre.
				...
				\subsubsection{Récupération de voisinage}
					...
					liste de points voisins de celui-ci. Le degré de voisinage permet d'obtenir des voisins plus éloignés, ce paramètre définissant le 
				...
				\subsubsection{Translation de points}
					...
					\end{verbatim}
					Ces trois fonctions permettent au développeur d'effectuer des translation sur un ou plusieurs points, selon un vecteur passé en 
					paramètres ("move").
			...
			\subsection{Les méthodes de la classe MeshManager}
				...
				\subsubsection{Ajout et suppression}
					...
					\begin{verbatim}
						...
						void clear();
					\end{verbatim}
					Ces fonctions d'ajout et suppression permettent de ne pas gérer nous même les suppressions d'objets de la mémoire, puisque le manager 
					s'en occuper. Ainsi, la programmation s'en retrouve moins compliquée.
