		...
		\section{API}
			...
			\subsection{Les méthodes de la classe MeshTool}
				...
				\subsubsection{Les outils de sculpture}
					...
					Les paramêtres des outils:
					move correspond au déplacement du curseur sur l'objet,
					mesh représente le maillage sélectionné,
					last_position correspond au coordonnée 3D de la dernière position du curseur,
					brushSize représente le rayon où l'outil va etre appliqué. Ce brush permet d'avoir les listes des sommets contenus dans ce disque, 
					strength correspond à la force de l'application. Plus la force est fort, plus la modification par l'outil va etre significative, 
					modifiers correspond à l'activation de la touche shift. Celle-ci permettra de creuser l'objet si on y appuye dessus.
...
%==========================================================================================================================================================
	\chapter{Post-Mortem}
		...
		\section{Fonctionnalités non implémentées}
			%TODO : mode miroir, déplacement des lumières, matériaux
			
		\section{Améliorations réalisables}
			%TODO : optimisation, enrichir, meilleure décimation, rotation selon angle de vue actuel
